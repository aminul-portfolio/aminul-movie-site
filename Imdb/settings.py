...
SECRET_KEY = 'h@lt*g*)1o3kv*!h9b&&k_af2#3g(^+$ywez^riuh-26ens(16'
...
# Add any additional settings below as needed
# 📧 Email backend for development (sends email to console)
